...
const mockNotifications: Notification[] = [
  {
    ...
    message: "Sua reserva #R2023001 foi cancelada",
    type: "reservation",
    status: "unread",
    timestamp: "2 min ago",
  },
  {
    ...
    message: "Reserva #R2023002 foi finalizada com sucesso",
    type: "reservation",
    status: "unread",
    timestamp: "5 min ago",
  },
  {
    ...
    message: "Checklist de retorno foi aprovado",
    type: "checklist",
    status: "unread",
  ...
  {
    id: "4",
    title: "Seu Carro está Disponível!",
    message: "Veículo Toyota Camry está pronto para retirada",
    type: "system",
    status: "unread",
  ...
  },
  {
    ...
    message: "Sua reserva #R2023003 foi aprovada",
    type: "reservation",
    status: "read",
      ...
      <div className="border-b border-border p-4">
        <div className="flex items-center justify-between">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="text-[#1558E9] hover:text-[#1558E9]/80"
          >
            Limpar Notificações
          </Button>
        </div>
      ...
      <div className="p-4">
        ...
        <div className="space-y-3">
          {unreadNotifications.map((n) => (
            <div
              key={n.id}
              className="flex cursor-pointer items-start gap-3 rounded-lg border border-border p-3 hover:bg-accent/50"
            >
