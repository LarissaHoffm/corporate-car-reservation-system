...
const navItems: NavItem[] = [
  { title: "Dashboard",    href: "/dashboard",    icon: LayoutDashboard, roles: ["ADMIN","APPROVER","REQUESTER"], end: true },
  { title: "Reservations", href: "/reservations", icon: Calendar,        roles: ["ADMIN","APPROVER","REQUESTER"] },
  { title: "Gas Stations", href: "/gas-stations", icon: MapPin,          roles: ["ADMIN","APPROVER","REQUESTER"] },
  { title: "Documents",    href: "/documents",    icon: FileText,        roles: ["ADMIN","APPROVER","REQUESTER"] },
  { title: "Checklist",    href: "/checklist",    icon: CheckSquare,     roles: ["ADMIN","APPROVER","REQUESTER"] },
  { title: "Reports",      href: "/reports",      icon: BarChart3,       roles: ["ADMIN","APPROVER","REQUESTER"] },
  // ADMIN/APROVER
...
const supportItems: NavItem[] = [
  { title: "My Profile",   href: "/my-profile",   icon: User,            roles: ["ADMIN","APPROVER","REQUESTER"] },
...
export function SidebarNav({ userRole, baseHref }: Props) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="mb-3 text-xs font-semibold uppercase tracking-wider text-muted-foreground">MAIN</h3>
      ...
      <div>
        <h3 className="mb-3 text-xs font-semibold uppercase tracking-wider text-muted-foreground">SUPPORT</h3>
        <ul className="space-y-1">
