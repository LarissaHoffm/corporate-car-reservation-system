...
const mockNotifications: Notification[] = [
  ...
  {
    id: "2",
    title: "Solicitação de Reserva Finalizada",
    type: "completed",
    isRead: true,
  },
  ...
  {
    id: "4",
    title: "Seu Carro esta Disponível!",
    type: "available",
    isRead: true,
  },
  {
...
export function NotificationsOverlay({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/20" onClick={onClose}>
      <div
        className="absolute left-0 top-0 h-full w-80 bg-card shadow-lg border-r border-border/50"
        ...
        <div className="border-b border-border/50 p-4">
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-[#1558E9]">
                ReservCar
              </span>
            </div>
            <Button
          ...
          <div className="relative">
            ...
            <Input
              placeholder="Search..."
              className="h-10 pl-10 focus:ring-2 focus:ring-[#1558E9] focus:ring-offset-2"
            />
          </div>
        </div>
              ...
              <div className="space-y-2">
                {unreadNotifications.map((n) => (
                  <div
                    key={n.id}
                    className={cn(
                      "flex items-center gap-3 rounded-lg border-l-4 bg-background p-3 shadow-sm",
          ...
          {readNotifications.length > 0 && (
            <>
              <div className="px-4 py-2">
                <Button
                  variant="ghost"
                  className="w-full text-sm text-muted-foreground hover:text-foreground focus:ring-2 focus:ring-[#1558E9] focus:ring-offset-2"
                >
                  Limpar Notificações
                </Button>
              </div>
