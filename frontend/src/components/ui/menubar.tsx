...
function Menubar(props: React.ComponentProps<typeof MenubarPrimitive.Root> & { className?: string }) {
...
const MenubarMenu = (p: React.ComponentProps<typeof MenubarPrimitive.Menu>) => (
  <MenubarPrimitive.Menu data-slot="menubar-menu" {...p} />
);
const MenubarGroup = (p: React.ComponentProps<typeof MenubarPrimitive.Group>) => (
  <MenubarPrimitive.Group data-slot="menubar-group" {...p} />
);
const MenubarPortal = (p: React.ComponentProps<typeof MenubarPrimitive.Portal>) => (
  <MenubarPrimitive.Portal data-slot="menubar-portal" {...p} />
);
const MenubarRadioGroup = (p: React.ComponentProps<typeof MenubarPrimitive.RadioGroup>) => (
  <MenubarPrimitive.RadioGroup data-slot="menubar-radio-group" {...p} />
);
...
const MenubarSub = (p: React.ComponentProps<typeof MenubarPrimitive.Sub>) => (
  <MenubarPrimitive.Sub data-slot="menubar-sub" {...p} />
);
